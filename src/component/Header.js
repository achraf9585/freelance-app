  ...
  <>
     ...
     <div data-collapse="medium" data-animation="default" data-duration="400" data-w-id="78fd20c4-2009-a6a3-7378-0df69d2dbd82" data-easing="ease" data-easing2="ease" role="banner" class="navbar w-nav">
       <div class="container-navigation grid w-container">
         <a href="index.html" id="w-node-_78fd20c4-2009-a6a3-7378-0df69d2dbd84-9d2dbd82" data-w-id="78fd20c4-2009-a6a3-7378-0df69d2dbd84" aria-current="page" class="logo-link w-inline-block w--current"><img src="https://uploads-ssl.webflow.com/623b341060c39e4dc7b99525/623c6048d9f33b37ec6d4826_logo.png" loading="lazy" width="138" alt="" class="bo-logo"/>
           <p class="top-text">Born in curiosity, raised by dedication.</p>
         </a>
           ...
           <Link to={'/'} class="navlink w-inline-block">
            ...
            <div class="text-primary">Contact</div>
             ...
             <a href="contact.html" class="navlink w-inline-block">
               ...
               <a href="#" data-node-type="commerce-cart-open-link" class="w-commerce-commercecartopenlink cart-button w-inline-block"><img src="https://uploads-ssl.webflow.com/623b341060c39e4dc7b99525/623c61f9f88d13469188a7d8_cart.png" width="19" alt="" class="cart-image"/>
